<template>
  ...
  <div
    class="search-bar navbar-style z-[2] flex items-center gap-2.5 px-2 py-1 rounded-full fixed bottom-180 right-0 -translate-x-1/2 w-[50%] justify-between flex-wrap md:absolute md:top-7 md:right-15 md:left-auto md:bottom-auto md:translate-x-0 md:w-auto md:flex-nowrap"
  >
  ...
  <aside
    class="navbar-style fixed z-50 w-[90%] bottom-105 left-1/2 -translate-x-1/2 flex flex-row justify-around items-center gap-2 p-3 rounded-2xl md:top-1/2 md:left-5 md:translate-x-0 md:-translate-y-1/2 md:w-20 md:flex-col md:justify-start md:items-stretch md:gap-2 md:rounded-full"
    ref="menuRef"
  >
    <button
      @click="locateUser"
