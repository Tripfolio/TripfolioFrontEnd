<template>
  <div class="relative">
    <div class="flex flex-col lg:flex-row h-screen">
      <!-- 左側：可放地圖或其他內容 -->
      <div class="h-[55%] lg:h-full lg:w-4/6 bg-[#c2c2c2] p-4 relative overflow-hidden">
      ...
      <!-- 右側：行程列表區-->
      <div class="flex-1 lg:w-2/6 h-[45%] lg:h-full overflow-y-auto bg-[#c2c2c2] sm:border-t lg:border-t-0">
