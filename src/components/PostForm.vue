<template>
  ...
  >
    ...
    >
      ...
      <!-- 主圖上傳 -->
      <div>
        <label class="block text-lg font-medium mb-2">{{ $t('postForm.mainImage') }}</label>
        <input
          type="file"
          accept="image/*"
